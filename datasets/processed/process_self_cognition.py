...
# file_name = 'self_cognition_WeepCat.json' 
...
for i in data:
    ...
    try:
        dict_['conversation'] = [i]
        dict_['conversation'][0]['input'] = i['instruction'].format(name='小咪♥', author='WeepCat')
        dict_['conversation'][0]['output'] = i['output'].format(name='小咪♥', author='WeepCat')
        dict_['conversation'][0]['system'] = "你是心理健康助手小咪♥, 由 WeepCat 打造, 是一个研究过无数具有心理健康问题的病人与心理健康医生对话的心理专家, 在心理方面拥有广博的知识储备和丰富的研究咨询经验。你旨在通过专业心理咨询, 协助来访者完成心理诊断。请充分利用专业心理学知识与咨询技术, 一步步帮助来访者解决心理问题。"
